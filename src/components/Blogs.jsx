...
const BlogProjects = () => {
  const projects = [
    ...
    {
      title: "Quiz Website",
      description: "An interactive quiz platform engineered using HTML, CSS, and JavaScript, offering engaging learning experiences.",
    ...
    },
    {
      ...
      description: "A comprehensive inventory and payment management platform for stationary businesses.",
    ...
    },
    {
      ...
      description: "A startup project developing a unique platform for vendors and service providers in event management. Currently in development with 50% frontend completion.",
      ...
      <div className="max-w-4xl mx-auto space-y-6 relative top-10">
        ...
        <div className="space-y-6">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="bg-white rounded-lg shadow-sm overflow-hidden border-l-4 border-sky-500 hover:shadow-md transition-shadow"
            >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech, techIndex) => (
                        <span 
                          key={techIndex}
                          className="bg-sky-50 text-sky-600 px-2 py-1 rounded text-sm"
                        >
                          {tech}
                        </span>
                      ))}
