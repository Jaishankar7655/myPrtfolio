      ...
      <div className="max-w-4xl mx-auto space-y-6 mt-10">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-sky-500">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <img
              src="https://jaishankar-port.netlify.app/pic.png"
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-purple-500">
          ...
          <div className="space-y-3">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-600">Completed comprehensive training in modern web development technologies</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <h4 className="font-semibold text-gray-800 mb-1">Python Programming</h4>
              <p className="text-gray-600">Advanced certification in Python programming and web frameworks</p>
            </div>
          </div>
        </div>
